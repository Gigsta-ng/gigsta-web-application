...
const Navbar = () => {
  ...
  return (
    <Wrapper className="w-full">
      <div className={`flex w-full justify-between items-center ${screenHeight && screenHeight >= 60 && screenWidth! <= 620 && "fixed left-[5%] transition-all -translate-x-[2.5%] w-[95%]"} z-50 rounded-[32px] max-md:bg-black/10 max-md:p-2 max-md:px-4 max-md:backdrop-blur-lg`}>
        <Logo />
