...
const Footer = () => {
  return (
    <footer id="contact" className="pt-12 border-t border-gray-800">
      <Wrapper className="flex justify-between max-md:flex-col lg:gap-[10%]">
        ...
        <div className="flex-1 flex max-md:flex-col gap-6 md:gap-[20%] max-md:pt-10">
          <div className="space-y-4">
          ...
          <div className="lg:space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span className="md:text-lg md:text-[20]">gigsta@gigsta.com</span>
              </div>
            </div>
